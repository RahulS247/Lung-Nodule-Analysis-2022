...
from layers.large_seblock import SeResBlock
...
def lung_model(data_size_in, n_classes: int, verbose: int = 1, keras_aug=False) -> keras.Model:
    ...
    x = SeResBlock(x, filter_1=64, filter=256, reg=reg, init=init)
    x = SeResBlock(x, filter_1=64, filter=256, reg=reg, init=init)
    x = SeResBlock(x, filter_1=64, filter=256, reg=reg, init=init)

    x = SeResBlock(x, filter_1=128, filter=512, reg=reg, init=init)
    x = SeResBlock(x, filter_1=128, filter=512, reg=reg, init=init)
    x = SeResBlock(x, filter_1=128, filter=512, reg=reg, init=init)
    x = SeResBlock(x, filter_1=128, filter=512, reg=reg, init=init)

    x = SeResBlock(x, filter_1=256, filter=1024, reg=reg, init=init)
    x = SeResBlock(x, filter_1=256, filter=1024, reg=reg, init=init)
    x = SeResBlock(x, filter_1=256, filter=1024, reg=reg, init=init)
    x = SeResBlock(x, filter_1=256, filter=1024, reg=reg, init=init)
    x = SeResBlock(x, filter_1=256, filter=1024, reg=reg, init=init)
    ...
    x = SeResBlock(x, filter_1=512, filter=2048, reg=reg, init=init)
    x = SeResBlock(x, filter_1=512, filter=2048, reg=reg, init=init)
    x = SeResBlock(x, filter_1=512, filter=2048, reg=reg, init=init)
