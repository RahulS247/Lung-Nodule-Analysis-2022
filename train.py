...
def main(problem: str):
    ...
    model_efficientb0.save('pretrained_weights/efficientb0_weights.h5')

    PRETRAINED_efficientb0_WEIGHTS_FILE = (
        Path().absolute()
        / "pretrained_weights"
        / "efficientb0_weights.h5"
    )
    ...
    model.load_weights(str(PRETRAINED_efficientb0_WEIGHTS_FILE), by_name=True, skip_mismatch=True)
